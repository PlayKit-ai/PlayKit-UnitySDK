...
{
    /// <summary>
    /// Custom Editor for PlayKit_NPCClient with i18n support.
    /// Provides a user-friendly interface for configuring NPC settings.
    /// </summary>
    [CustomEditor(typeof(PlayKit_NPCClient))]
    public class NPCClientEditor : UnityEditor.Editor
    {
        ...
        private void DrawRuntimeStatus()
        {
            ...
            if (showRuntimeStatus)
            {
                ...
                var npc = (PlayKit_NPCClient)target;
        ...
        private void DrawModulesInfo()
        {
            ...
            var npc = (PlayKit_NPCClient)target;
            var actionsModule = npc.GetComponent<PlayKit_NPCClient_ActionsModule>();
            var voiceModule = npc.GetComponent<PlayKit_NPCClient_VoiceModule>();
